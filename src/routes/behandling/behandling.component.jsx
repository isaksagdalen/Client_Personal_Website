        ...
        <div className="container grid grid--2-cols align-center-v margin-bottom-huge">
          ...
          <div className="behandling-text-box">
            ...
            <p className="behandling-paragraph">
              Psykiske lidelser har mange ulike former, men fellesnevneren er at
              de er svært plagsomme. De tar knekken på energi og livsglede. Har
              man en psykisk plage, blir det enkelte ganger vanskelig å fungere
              normalt i arbeid, på skole, i familie og sosialt.
            </p>
            <p className="behandling-paragraph">
              Gjennom samtaleterapi kan du få hjelp til å håndtere dine vansker.
              En viktig forutsetning er at du er motivert og er villig til å
              bruke en del tid og krefter på dette arbeidet.
            </p>
            <p className="behandling-paragraph">
              I starten bruker vi litt tid på å utforske dine problemområder,
              forsøke å sette dem i sammenheng og definere målsettinger. Det er
              viktig at det er du selv velger målsettinger og fokus for
              samtaleterapi.
            </p>
          </div>
        </div>
        ...
        <div className="container grid grid--2-cols ">
          <div className="behandling-list-box">
            ...
            <div className="behandling-paragraph">
              ...
              mentaliseringsbasert terapi, EMDR og Intensive Short-Term Dynamic
              Psychotherapy (ISTDP).
            </div>
          </div>
          <div className="behandling-image-box">
